...
urlpatterns = [
    ...
    path("api/charactertrait_strength/", CharacterTraitView.as_view(), name="character_trait_strength_api"),
    path("api/charactertrait_defect/", CharacterTraitView.as_view(), name="character_trait_defect_api"),
